  ...
  return (
    <Fragment>
      ...
      <header className="wrapper bg-soft-primary">
        <Navbar search stickyBox={false} logoAlt="logo-light" navClassName="navbar navbar-expand-lg center-nav transparent position-absolute navbar-dark" button={<NextLink title="Contact" href="#" className="btn btn-sm btn-white rounded-pill" />} />
      </header>

      <main className="content-wrapper">

        <section className="wrapper image-wrapper bg-image bg-overlay text-white" style={{
          backgroundImage: 'url(/img/photos/bg5.jpg)'
        }}>
                ...
                <div className="post-header">
                  ...
                  <ul className="post-meta text-white">
                    ...
                    <li className="post-comments">
                      ...
                      <NextLink href="#" className="text-reset" title={<Fragment>
