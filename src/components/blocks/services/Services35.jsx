    ...
    <div className="container py-15 py-md-17">
      <div className="row">
        <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 mx-auto text-center">
          <h2 className="fs-16 text-uppercase text-primary mb-3">Why Choose CEEN | ســـــين?</h2>
          <h3 className="display-3 mb-10 px-xl-10 px-xxl-15">
            Here are a few reasons why our customers choose  CEEN | ســـــين .
          </h3>
        </div>
      </div>
          ...
          <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            <div className="col-lg-6">
              <div className="row gx-md-5 gy-5 align-items-center">
                <div className="col-6">
                  <img alt="" src="/img/photos/sa13.jpg" srcSet="/img/photos/sa13@2x.jpg 2x" className="img-fluid rounded shadow-lg d-flex ms-auto" />
                </div>

                <div className="col-6">
                  <img alt="" src="/img/photos/sa14.jpg" srcSet="/img/photos/sa14@2x.jpg 2x" className="img-fluid rounded shadow-lg mb-5" />
                  <img alt="" src="/img/photos/sa15.jpg" srcSet="/img/photos/sa15@2x.jpg 2x" className="img-fluid rounded shadow-lg d-flex col-10" />
                </div>
              </div>
            </div>
          ...
          <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            <div className="col-lg-6 order-lg-2">
              <div className="row gx-md-5 gy-5">
                <div className="col-5">
                  <img alt="" src="/img/photos/sa9.jpg" srcSet="/img/photos/sa9@2x.jpg 2x" className="img-fluid rounded shadow-lg my-5 d-flex ms-auto" />
                  <img alt="" src="/img/photos/sa10.jpg" srcSet="/img/photos/sa10@2x.jpg 2x" className="img-fluid rounded shadow-lg d-flex col-10 ms-auto" />
                </div>

                <div className="col-7">
                  <img alt="" src="/img/photos/sa11.jpg" srcSet="/img/photos/sa11@2x.jpg 2x" className="img-fluid rounded shadow-lg mb-5" />
                  <img alt="" src="/img/photos/sa12.jpg" srcSet="/img/photos/sa12@2x.jpg 2x" className="img-fluid rounded shadow-lg d-flex col-11" />
                </div>
              </div>
            </div>
        ...
        <div className="tab-pane fade" id="tab2-3" role="tabpanel">
          <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            <div className="col-lg-6">
              <div className="row gx-md-5 gy-5">
                <div className="col-6">
                  <img alt="" src="/img/photos/sa5.jpg" srcSet="/img/photos/sa5@2x.jpg 2x" className="img-fluid rounded shadow-lg mb-5" />
                  <img alt="" src="/img/photos/sa6.jpg" srcSet="/img/photos/sa6@2x.jpg 2x" className="img-fluid rounded shadow-lg d-flex col-10 ms-auto" />
                </div>

                <div className="col-6">
                  <img alt="" src="/img/photos/sa7.jpg" srcSet="/img/photos/sa7@2x.jpg 2x" className="img-fluid rounded shadow-lg my-5" />
                  <img alt="" src="/img/photos/sa8.jpg" srcSet="/img/photos/sa8@2x.jpg 2x" className="img-fluid rounded shadow-lg d-flex col-10" />
                </div>
              </div>
            </div>
