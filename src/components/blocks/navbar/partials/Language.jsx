import { useState } from 'react'; // language list

const supportLanguage = ['En', 'Ar', 'Es', 'De'];

const Language = () => {
  const [language, setLanguage] = useState(supportLanguage[0]);
  return <li className="nav-item dropdown language-select text-uppercase">
    ...
    <ul className="dropdown-menu">
      {supportLanguage.map(lang => <li className="nav-item" key={lang}>
