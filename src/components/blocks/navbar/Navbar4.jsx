...
import SocialLinks from 'components/reuseable/SocialLinks'; // -------- partial header component -------- //
      ...
      <nav ref={navbarRef} className={sticky ? fixedClassName : navClassName}>
        <div className="container flex-lg-column">
          ...
          <div className="navbar-collapse-wrapper bg-white d-flex flex-row align-items-center justify-content-between">
            ...
            <div className="navbar-collapse offcanvas offcanvas-nav offcanvas-start" data-bs-scroll="true" id="offcanvas-nav">
