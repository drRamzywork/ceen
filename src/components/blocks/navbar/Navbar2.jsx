...
import Language from './partials/Language'; // -------- data -------- //
...
const Navbar2 = ({
  ...
  const fixedClassName = `navbar navbar-expand-lg extended navbar-light navbar-bg-light caret-none navbar-clone fixed navbar-stick`; // render inner nav item links
      ...
      <div className="container flex-lg-column">
        <div className="topbar d-flex flex-row w-100 justify-content-between align-items-center">
          <div className="navbar-brand">
            <NextLink href="/" title={<img alt="logo" src="/img/logo-dark.png" srcSet="/img/logo-dark@2x.png 2x" />} />
          </div>
