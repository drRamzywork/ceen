import Image from 'next/image'; // -------- custom component -------- //
...
const Footer14 = () => {
  return <footer className="bg-dark section-frame mt-15">
    <div className="container pb-13 pb-md-15">
      {
        /* ========== newsletter section ========== */
      }
      <div className="card image-wrapper bg-full bg-image bg-overlay mt-n50p mx-md-5" style={{
          ...
          <div className="col-md-4 col-lg-3">
            <div className="widget">
              <figure className="mb-4">
                <Image alt="logo" width={134} height={26} src="/img/logo-light.png" style={{
                  width: '100%',
                  height: 'auto'
                }} />
              </figure>
              ...
              <p className="mb-4">
                © 2024 Sandbox. <br className="d-none d-lg-block" />
                All rights reserved.
              </p>
